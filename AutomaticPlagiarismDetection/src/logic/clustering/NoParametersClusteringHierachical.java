...
public class NoParametersClusteringHierachical implements ClusteringAlgorithm {
	
	private double ratio;
	
	public NoParametersClusteringHierachical(double ratio) {
		this.ratio = ratio;
	}
